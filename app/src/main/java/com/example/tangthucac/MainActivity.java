...
import com.google.firebase.auth.FirebaseAuth;import androidx.annotation.NonNull;
import androidx.appcompat.app.AppCompatActivity;
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, task -> {
                    if (task.isSuccessful()) {
                        ...
                        startActivity(new Intent(this, HomeActivity.class)); // Chuyển sang màn hình chính
                        finish();
                    } else {
